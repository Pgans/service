      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0">
        <tr   > 
          ...
          <td colspan="5" align="center" valign="top" background="imag/bg_logo.gif" ><font size="3" face="MS Sans Serif, Tahoma, sans-serif"> 
            <?
									...
									echo "<br><font size=3><b>ปฎิทินการรับแจ้งซ่อมบำรุง เดือน ",$monthnew[$month-1];echo "\t\t",date( " $year"+543),"</font>";
								?>
            </font> </td>
          <td align="center" valign="top" background="imag/bg_logo.gif"> <a href=" 
								<?
        ...
        <td align='right' valign='top' background="imag/mainpage.gif"  class="Some" <? 
          ...
          <?		
									...
									$sql="select * from jobcom  where datejob='$today[year]-$month-$day'  order by datejob asc";
									...
									echo"<a href='#' target='top' ><font color=green size='2' face='MS Sans Serif, Tahoma, sans-serif'>";
									...
									echo"<font color=>";
									echo"<a href='#' target='_top' title='$object->datail' >";
...
<div align="right"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"></font></div>
