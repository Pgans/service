...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="imag/mainpage.gif">
  ...
  <tr> 
    <form name="form1" method="post" action="index.php?show=main&who=1">
	...
	//echo $sql;
			...
			?>
          </font><font face="tahoma"><font size="2"><strong>
          <? ?>
          </strong></font></font></div></td>
    </form>
  </tr>
  <tr> 
    <td><table width="99%" border="0" align="center" cellpadding="3" cellspacing="1">
        <tr bgcolor="#6464FF">
          ...
          <td width="8%"><div align="center"><font color="#FFFFFF"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วดป.ที่ต้องการ</font></strong></font></div></td>
          <td width="9%"><div align="center"><font color="#FFFFFF"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">หน่วยงาน</font></strong></font></div></td>
          <td width="7%" bgcolor="#6464FF"><div align="center"><font color="#FFFFFF"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ผู้แจ้ง</font></strong></font></div></td>
          <td width="16%" bgcolor="#6464FF"><div align="center"><a href="index.php?show=main&orderby=jobcom_service.type"><font color="#FFFFFF" size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>ประเภทงาน</strong></font></a></div></td>
          <td width="6%"><font color="#FFFFFF" size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>ผู้รับงาน</strong></font></td>
          <td width="7%"><div align="center"><font color="#FFFFFF"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วดป.ส่งงาน</font></strong></font></div></td>
          ...
          <td width="8%"><font color="#FFFFFF" size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>แก้ไข 
            / ลบ</strong></font></td>
          <? } ?>
        </tr>
        <tr>
          ...
          <td bgcolor="#FFFFFF"><font size="2" face="MS Sans Serif, Tahoma, sans-serif">
            <? if(isset($_SESSION['user'])){?>
            <a href="index.php?show=add_job&what=edit&id=<? echo $row->id;?>" title="<? echo $row->datail;?>"><? echo $row->head;?></a>
            <? }else{?>
            <? echo $row->head;?>
            <? } ?>
          </font></td>
...
php?>
          ...
          <? if(isset($_SESSION['user'])){?>
          <td bgcolor="#FFFFFF"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong><a href="index.php?show=add_job&what=edit&id=<? echo $row->id;?>">แก้ไข</a></strong></font> / <strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><a href="index.php?show=main&what=del&id=<? echo $row->id;?>">ลบ</a></font></strong></td>
          <? } ?>
        </tr>
        <? } ?>
        <tr>
