...
<CENTER>
  <h2><font size="2" face="MS Sans Serif, Tahoma, sans-serif">กราฟแสดงการใช้ระบบ COMS แยกตามประเภทปัญหา</font></h2>
<?php
	...
	$strXML = "<chart caption='กราฟ COMS ฝ่ายงาน' subCaption='By armds' pieSliceDepth='30' showBorder='1' formatNumberScale='0' numberSuffix=' ครั้ง'>";
	...
	//echo renderChart("FusionCharts1/Line.swf", "", $strXML, "ประเภทปัญหา", 1200, 300, false, false);
	echo renderChart("FusionCharts1/Bar2D.swf", "", $strXML, "ประเภทปัญหา", 600, 1000, false, false);
	//echo renderChart("FusionCharts1/Pie3D.swf", "", $strXML, "ประเภทปัญหา", 600, 1200, false, false);
