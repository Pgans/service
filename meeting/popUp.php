  ...
  <table width="564" border="0" cellspacing="2" cellpadding="0" >
    <tr height="35">
      ...
      <td width="384" align="center"><div align="left">
          <? if((($UID==$_SESSION['Usernamep'])and($_SESSION['Usernamep']!=''))or($ID=='')or($_SESSION['Usernamep']=='admin')){?><input name="subject" type="text" id="subject" value="<?=$subject2;?>" size="30" maxlength="30">
          <? }else{ echo $subject2;}?>
    ...
    <tr height="35">
      ...
      <td align="center"><div align="left">
	  <? if((($UID==$_SESSION['Usernamep'])and($_SESSION['Usernamep']!=''))or($ID=='')or($_SESSION['Usernamep']=='admin')){?>
        <input name="num" type="text" value="<?=$num1;?>" id="num" size="2" maxlength="3"><? }else{ echo $num1; }?>
        คน      </div></td>
    </tr>
    <tr height="35">
    ...
    <tr height="35">
      ...
      <td align="left" valign="top"><div align="left">
        <p>
          ...
          <input type="radio" name="type" value="U"<?php if($T=="U"){echo "checked";}?> onClick="javaScript:if(this.checked){document.all.t_other.style.display='none';}">
            แบบตัว U</label>
          <br>
          <label>
            <input type="radio" name="type" value="T"<?php if($T=="T"){echo "checked";}?> onClick="javaScript:if(this.checked){document.all.t_other.style.display='none';}">
            แบบแถวตอน</label>
          <br>
          <label>
            <input type="radio" name="type" value="C"<?php if($T=="C"){echo "checked";}?> onClick="javaScript:if(this.checked){document.all.t_other.style.display='none';}">
            แบบใช้เฉพาะเก้าอี้ แบบตัว U</label>
          <br>
          <label>
            <input type="radio" name="type" value="N"<?php if($T=="N"){echo "checked";}?> onClick="javaScript:if(this.checked){document.all.t_other.style.display='none';}">
          ...
          <label>
            ...
            อื่น</label>
          <input name="t_other" type="text" id="t_other" value="<?=$TO;?>" style="display:'none'">
		  <? }else{
		  if($T=="O"){
		  echo $TO;
		  }elseif($T=="U"){
...
เครื่องฉายสไลด์</label>
        ...
        <br>
        <label>
        <input name="other" type="checkbox" id="other" value="1"<?php if($other1=="1"){echo "checked";} ?>>
       <?=$other1;?> อื่น ๆ</label>
        <input name="m_other" type="text" id="m_other" value="<?=$MO;?>">
        <? }else{
