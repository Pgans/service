...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="25" background="imag/mainpage.gif"><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>&nbsp;&nbsp;<font size="3">เพิ่มข้อมูล</font></strong></font></td>
  </tr>
  <tr> 
    <td><form name="form1" method="post" action="add_what.php">
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="8%"><div align="right"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">เลขที่</font></strong></div></td>
            <td width="43%">
			<? 
			if($what=="edit"){
            ...
            <td width="49%"><font size="3" face="MS Sans Serif, Tahoma, sans-serif"><strong>สำหรับผู้ดูแลระบบ</strong></font></td>
          </tr>
          <tr> 
            <td><div align="right"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วดป.ที่แจ้ง</font></strong></div></td>
	...
	<!--
            ...
            <td rowspan="5"> 
              ...
              <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td width="19%"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วันที่รับงาน</font></strong></td>
	...
	<!--
                ...
                <tr> 
                  <td><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ประมาณการ</font></strong></td>
                ...
                <tr> 
                  <td><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">วดป.ที่เสร็จ</font></strong></td>
                  <td><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif"> 
	...
	<!--
                ...
                <tr> 
                  <td><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">สถานะ</font></strong></td>
                  <td><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif"> 
                ...
                <tr> 
                  <td><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">ประเภทงาน</font></strong></td>
                  <td> 
                ...
                <tr>
                  <td><font size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>ผู้รับงาน</strong></font></td>
                  <td>
          ...
          <tr> 
            <td><div align="right"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">กิจกรรม 
                / งาน</font></strong></div></td>
            <td> <input name="head" type="text" id="head" value="<? if($what=="edit"){echo $row_new->head;}?>" size="30"></td>
          </tr>
          <tr> 
            <td><div align="right"><strong><font size="2" face="MS Sans Serif, Tahoma, sans-serif">รายละเอียด</font></strong></div></td>
          ...
          <tr> 
            <td colspan="3"><div align="center"> 
                ...
                <input type="button" name="Submit2" value="  ยกเลิก  " onClick="javascript :  history.back(); ">
                </font></div></td>
          </tr>
        </table>
