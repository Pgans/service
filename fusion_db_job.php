...
<?php
	...
	$strXML = "<chart caption='กราฟ COMS  แยกตามประเภทปัญหา  ช่วงวันที่  $a1/10/01  ถึง   $a2/09/30  ' subCaption='By Chatree_Muangsamsib_Hospital' pieSliceDepth='30' showBorder='1' formatNumberScale='0' numberSuffix=' ครั้ง'>";
	...
	if ($result) {
		while($ors = mysql_fetch_array($result)) {
			...
			$strQuery = "select count(id) as TotOutput from jobcom_service  where datework between '".$a1."/10/01' and '".$a2."/09/30'  and type=" . $ors['id']; //echo $strQuery;
