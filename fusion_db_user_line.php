...
<?php
	...
	$strXML = "<chart caption='กราฟ COMS ผู้รับงาน' subCaption='By armds' pieSliceDepth='30' showBorder='1' formatNumberScale='0' numberSuffix=' ครั้ง'>";
	...
	if ($result) {
		while($ors = mysql_fetch_array($result)) {
			...
			$strQuery = "select count(id) as TotOutput from jobcom_service  where user_job='" . $ors['pwd']."' ";
